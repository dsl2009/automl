...
def run(trainr, test_dr,name,svdr,  checkdrs):
    ...
    data_loader = DataLoader(imagenet_data, batch_size=batch_size, shuffle=True)
    model = gen_efficientnet.efficientnet_b0(num_classes=1000,drop_rate=0.8,drop_connect_rate=0.5)
    ...
    optimizer = over9000.Over9000(model.parameters(),weight_decay=0.01)
